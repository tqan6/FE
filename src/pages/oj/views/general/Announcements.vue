  ...
  <Row type="flex" :gutter="18">
    ...
    <Col :span="5" v-if="!isContest" >
      ...
      <Panel shadow style="margin-top: 37px;padding-bottom: 5px;">
        ...
        <ul style="margin-left: 40px;margin-bottom: 20px;">
          <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();window.open('https://www.facebook.com/he1deng', '_blank');">😺 Admin Nguyễn Hải Đăng 😺</a></li>
          <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();window.open('https://www.facebook.com/tqan.gudboiz', '_blank');">🦁 Admin Đào Thế Quân 🦁</a></li>
      ...
      <Panel shadow style="margin-top: 37px;padding-bottom: 5px;">
        ...
        <ul style="margin-left: 40px;margin-bottom: 20px;">
            ...
            <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();">Tổng số bài nộp:😺 🦁</a></li>
            <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();">Số lượng thành viên: {{infoData.user_count + 50}}</a></li>
            <li style="padding: 5px 0px;"><a href="" class="link-style" onclick="event.preventDefault();">Số bài nộp hôm nay: {{infoData.today_submission_count + 50}}</a></li>
        </ul>
      </Panel>
    </Col>
  </Row>
